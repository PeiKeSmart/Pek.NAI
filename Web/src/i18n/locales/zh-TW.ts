export default {
  ...
  chat: {
    ...
    thinkingLayoutTip: '切換到右側分欄對照',
    thinkingLayoutRestoreTip: '恢復為內容上方',
    thinkingResizeTip: '拖動調整推理欄寬度',
    thinkingPrev: '上一條推理',
    thinkingNext: '下一條推理',
    prevUserMessage: '上一則使用者訊息',
    nextAssistantMessage: '下一則助手訊息',
    codeExpandAll: '展開全部（{{lines}} 行）',
    codeCollapse: '折疊程式碼',
    attachment: '附件',
  ...
  settings: {
    ...
    showToolCallsDesc: '開啟後在對話頂部顯示工具呼叫徽章和入參出參，方便調試 Agent 應用。',
    ...
    speedMax: '極速',
    thinkingLayout: '推理展示',
    thinkingLayoutDesc: '推理過程展示方式：預設上方摺疊、上方摺疊、上方展開或右側分欄對照（右側分欄寬度可拖動）。',
    thinkingLayoutDefault: '預設（上方摺疊）',
    thinkingLayoutCollapsed: '上方摺疊',
    thinkingLayoutExpanded: '上方展開',
    thinkingLayoutSide: '右側分欄',
    contentWidth: '內容區寬度',
  ...
  learning: {
    ...
    enableLearning: '啟用個人學習',
    enableLearningDesc: '開啟後，AI 將記住你的偏好並在對話中個人化回覆',
    memoriesDesc: 'AI 從對話中擷取的關於你的偏好和習慣',
    active: '生效中',
    inactive: '已停用',
    noMemories: '暫無記憶資料',
    confidence: '置信度',
    deactivate: '停用',
    activate: '啟用',
    loadMore: '載入更多（已顯示 {{loaded}} / 共 {{total}} 條）',
  },
  systemSettings: {
    title: '系統設定',
    saveSuccess: '系統設定已儲存',
    ...
    upload: {
      ...
      allowAnonymousShare: '允許匿名訪問分享',
      allowAnonymousShareDesc: '開啟後未登錄用戶也可查看分享連結；關閉後必須登錄才能訪問',
    },
    gateway: {
      enableGateway: '啟用閘道',
    ...
    learning: {
      ...
      embedModel: '嵌入模型',
      embedModelDesc: '向量檢索/嵌入場景使用的模型編碼，留空使用預設',
  ...
  share: {
    ...
    revokeSuccess: '分享連結已撤銷',    expireLabel: '有效期',  },
  sharePage: {
    title: '分享的對話',
    notFound: '連結已失效',
